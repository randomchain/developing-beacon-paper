...
\bigskip\noindent
We scrutinize which factors define how users should trust the beacon, and design our major contribution; a beacon protocol that uses an offset series \stefan{What is offset series?} of delay functions to provide constant\stefan{what is constant?} and secure randomness.
