\stefan{Title length }Randomness beacons are services that emit a random number at a regular interval.
\stefan{Order names by lastname}
...
Our beacon greatly minimizes the amount of trust needed in such a way that each user can decide how much they want to trust. As such, even fastidious users can be serviced by out randomness beacon. \stefan{give some concrete numbers from experiments}
