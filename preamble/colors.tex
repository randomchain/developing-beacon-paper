...
\definecolor{sectioning}{gray}{0.24}
\definecolor{subsectioning}{gray}{0.35}
\definecolor{paragraphing}{gray}{0.45}
...
\definecolor{OceanicNextBase00}{HTML}{1B2B34}
\definecolor{OceanicNextBase01}{HTML}{343D46}
\definecolor{OceanicNextBase02}{HTML}{4F5B66}
\definecolor{OceanicNextBase03}{HTML}{65737E}
\definecolor{OceanicNextBase04}{HTML}{A7ADBA}
\definecolor{OceanicNextBase05}{HTML}{C0C5CE}
\definecolor{OceanicNextBase06}{HTML}{CDD3DE}
\definecolor{OceanicNextBase07}{HTML}{D8DEE9}
\definecolor{OceanicNextBase08}{HTML}{EC5F67}
\definecolor{OceanicNextBase09}{HTML}{F99157}
\definecolor{OceanicNextBase0A}{HTML}{FAC863}
\definecolor{OceanicNextBase0B}{HTML}{99C794}
\definecolor{OceanicNextBase0C}{HTML}{62B3B2}
\definecolor{OceanicNextBase0D}{HTML}{6699CC}
\definecolor{OceanicNextBase0E}{HTML}{C594C5}
\definecolor{OceanicNextBase0F}{HTML}{AB7967}
\definecolor{OceanicNextBase10}{HTML}{FFFFFF}

\colorlet{Highlight}{GoogleBlue}
\ifDarkTheme
    \pagecolor{OceanicNextBase00}
    \color{OceanicNextBase05}
    \colorlet{sectioning}{OceanicNextBase0D}
    \colorlet{subsectioning}{OceanicNextBase0E}
    \colorlet{descriptionlabeling}{OceanicNextBase0F}
    \colorlet{Highlight}{OceanicNextBase02}
\fi
