...
\begin{description}
    ...
    \item[Deterministic Randomness] The beacon should deterministically compute a random output from a set of inputs. \mtjnote{So our beacon is deterministic. It cannot be random. Specify that by \enquote{random output} we actually mean unpredictable output. Maybe this definition could be moved up earlier in this paper?}
