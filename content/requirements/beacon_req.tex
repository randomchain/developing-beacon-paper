...
The protocol should be secure meaning that even if only a single participant is honest, the output is still unpredictable.
This single participant will in the worst case be you.
...
If users lose confidence in an operator, a new operator and thus new beacon, can be chosen instead.
