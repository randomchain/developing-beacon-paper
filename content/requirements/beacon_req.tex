...
\mtjnote{This meta text is not really good.}

\mtjnote{Maybe the separation between functional and nonfunctional is not benefitting us? Maybe just one list.}

\mtjnote{Major overhaul: Maybe have a discussion first, arguing for the requirements, then in the end have a list summarizing them.}
