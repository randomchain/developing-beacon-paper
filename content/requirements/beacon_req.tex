...
\mtjnote{Something about a beacon that is usable in the real world --- not just theoretical mumbo jumbo. Here, scalability, easy and painless to deploy can be \enquote{subitems}.}


\subsection{Open Protocol}
Anyone should be able to easily contribute to the beacon protocol to influence the random generation. There should be no requirements imposed on users to limit their contribution.
