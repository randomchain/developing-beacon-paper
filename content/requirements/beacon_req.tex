...
\stefan{Scalability? I thought that was your main goal}

\subsection{A Design that works in the real world}
\mtjnote{Something about a beacon that is usable in the real world --- not just theoretical mumbo jumbo --- also needs new title. Here, scalability and throughput (as well as free) can be \enquote{subitems}.}

\subsection{Transparent Operation}
\mtjnote{Maybe somewhere in this, is the \enquote{Secure} requirement, that I proposed?}
