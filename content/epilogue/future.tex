...
\mtjnote{We have assumed the beacon will be run for a greater good, however we do not really know if this is viable.
Write about that incentives need to be sorted out before anyone will run the beacon.}
