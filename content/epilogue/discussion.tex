...
\mtjnote{Write here that our users must have no critical dependency on output because dos is possible}
\mtjnote{You need to be flexible on e.g.\ input was not included in the output}
