...
Moreover, the pipeline architecture can be used to specify types of components as we did in~\vref{sub:components_of_a_beacon}. These types can then be aggregated according to a specification to define a complete beacon \mtjnote{What does this sentence mean? Isn't is obvious?}.
