...
An example could be that a user that can compute the delay function in 10 minutes believes that the world's fastest computer can do so 5 times faster, i.e.\ in 2 minutes.
...
For example, a user supplying an input every 10 seconds will have a better chance of coming close to the deadline.
