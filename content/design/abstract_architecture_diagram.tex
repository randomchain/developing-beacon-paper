\begin{figure}[htb]\pgfdeclarelayer{background}
    ...
    \begin{tikzpicture}[auto]
        ...
        \end{pgfonlayer}
    \end{tikzpicture}
    \caption{Abstract beacon architecture based on pipeline and services. Solid boxes illustrate services and arrows represent data flow.}\label{fig:beacon_arch}
\end{figure}
