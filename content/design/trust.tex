...
We present an equation, which if satisfied, says that the user can trust that the beacon operator is not capable of fooling them.
...
\begin{figure}
    ...
    \end{tikzpicture}
    \caption{Parallelized beacon protocol with four computation services.}\label{fig:beacon_parallel_timeline}
\end{figure}
