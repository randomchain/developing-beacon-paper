...
\mtjnote{Some meta text is missing (motivational). Don't start with "We propose two scenarious" --- softer start, please.}
...
\subimport{}{beacon_honest_timeline.tex}
...
\subimport{}{beacon_malicious_timeline.tex}
