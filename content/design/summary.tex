...
Similar to the withholding output attack, shutdown attacks by the beacon operator cannot be based on knowledge. The operator cannot know if the output favors anyone. It can only be performed randomly, and will thus make users suspicious of abnormal operation.
...
\begin{tabular}{@{}ll!{\color{clframe}\vrule}l@{}}
    ...
    \makecell[l]{\st{Shutdown} \\ \st{Withholding output}} &
