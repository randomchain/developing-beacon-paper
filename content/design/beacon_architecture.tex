\begin{figure}[htb]\pgfdeclarelayer{background}
    ...
    \begin{tikzpicture}[auto]
        ...
        \draw[arrow] (inputcoll1) -- (inputproc);
        \draw[arrow] (inputcoll2) -- (inputproc);
        \draw[arrow] (inputcoll3) -- (inputproc);

        \draw[arrow] (inputproc) -- (computation);

        \draw[arrow] (computation) -- (publish1);
        \draw[arrow] (computation) -- (publish2);
        \draw[arrow] (computation) -- (publish3);
