...
\begin{figure*}[htb]
    ...
    \begin{tikzpicture}[auto, remember picture]
        ...
        \draw ([yshift=.9em]ip.east) edge[out=0, in=180, arrow, bend left=30] ([yshift=.1em]comp1.west);
        \draw ([yshift=-.1em]comp1.west) edge[out=180, in=0, arrow, bend left=25] ([yshift=.8em]ip.east);
        \draw ([yshift=.1em]ip.east) edge[out=0, in=180, arrow, bend left=20] ([yshift=.1em]comp2.west);
        \draw ([yshift=-.1em]comp2.west) edge[out=0, in=180, arrow, bend left=20] ([yshift=-.1em]ip.east);
        ...
        % Explanations
        \node[text width=9em, align=left, anchor=east, below=5ex of ip.east] {1. \code{Ready}\\2. Data};
