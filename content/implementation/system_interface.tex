...
To limit the space of potential messages and message sizes passed around inside of our system, we sanitize the user inputs by hashing them at the entry point. \mtjnote{Make it more obvious, that hashing is a conscious choice and that it helps on cheese pizza}
