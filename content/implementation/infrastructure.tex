...
This pattern can potentially be applied to all components exposed as a single point of failure and would be sufficient in most cases of crashes. \rene{most cases ? How did you determine that, do you have in fault model in mind ? }
