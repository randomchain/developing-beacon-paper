...
However the proxy will be subjected to significantly larger messages, due to especially commits which must contain every input used in the output computation.
...
In the future \vref{sub:bottlenecks}, we evaluate the performance of our proxies.
