...
\mtjnote{Please rewrite totally.}

\mtjnote{Focus on realizing the design, while discussing the trade-offs.}

\mtjnote{Zeromq chosen because works in all languages. Python chosen for prototyping speed. Merkle trees is implementation of ordering and processing inputs. Sloth is implementation of delay function.}
