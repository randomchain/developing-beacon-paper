...
As we also need to account for the feasibility of the system in real world applications, we will consider the above assumption as non-binary, i.e.\ we perceive it as a system with variables. \rene{not sure non-binary and with variables are opposites; maybe maybe static/fices vs. variable?}
