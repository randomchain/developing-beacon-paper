...
As such, they decrease the number of rounds in the \gls{mpc} protocol from four to two, decrease the amount of communication between users, and decrease the complexity of the computation.
