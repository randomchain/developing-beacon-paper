...
\citet{mpcsnarks} suggest avoiding the heavy communication and computation of the \gls{mpc} and instead having users directly contribute a random number. \stefan{make this example more concrete somewhere in the paper. How much does the MPC approach cost, how much does ours. Can we compare them concretely, would strengthen this part a lot. }
