...
Based on a survey of randomness beacons, \citet{worldsbestpaper} \rene{Based on a survey of randomness beacons we made in previous work [14], we describe three sources of inputs} describe three sources of input:
...
Alongside presenting input source models, \citet{worldsbestpaper} \rene{see last comment} also identify three ways in which a beacon is typically operated:
