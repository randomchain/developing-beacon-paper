...
For quite a while, randomness beacons did not receive much attention. Circa 2010 a renewed interest in beacons could be seen as an increase in beacon-related literature.
...
The financial crisis led to the emergence of cryptocurrencies and to the sharp rise in popularity of blockchains --- technologies that promote decentralization and facilitate cooperation of mutually distrustful users. The litterature also contains a wealth of examples that combine blockchains and beacons to produce randomness either based on a blockchain, or as a smart contract running on a blockchain. 
