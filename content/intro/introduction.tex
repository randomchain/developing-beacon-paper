...
This recent literature presents some promising ways of creating an unbiasable beacon. Despite this, there still exists no \enquote{killer} \enquote{real-life} use cases of a randomness beacon. \mtjnote{Elaborate what is meant by killer and use more formal language} However, we see many potential use cases, that we describe in the following section.
