...
\mtjnote{Maybe this could look really good as an itemize? Then it is really clear what our contributions are: \gls{cco} with early release of inputs, pipeline parallelization, choice of Merkle tree data structure, and minor ones: Clever to hash inputs (cp) and multiple inputs and outputs.}
