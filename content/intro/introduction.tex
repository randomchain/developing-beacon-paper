...
While notable beacons implementing specialized \acrshort{mpc} exist~\cite{cascudo2017scrape, syta2017scalable}, they seem to focus on how to remedy scalability issues. This makes them less suited for public use, in which we do not control the number of users or their identities.
