...
The most straight-forward attack on either side of the availability is a \gls{dos} attack --- overwhelming the servers with requests to prevent them from servicing legitimate users. This type of attack is difficult to prevent, although it is possible to mitigate. %Bør uddybes en del.
...
\subsection{Other}
\fxnote{Add more security analysis things}
